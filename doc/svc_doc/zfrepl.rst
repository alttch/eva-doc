...
The service, which performs the collector role, is always online.
...
The service, which performs the replicator role, is automatically restarted on
pub/sub failures.
...
The service, which performs the standalone role, is always online.
